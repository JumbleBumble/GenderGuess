...
namespace MLModel_ConsoleApp1
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Gender");
            if (labelColumn == null)
            {
                throw new Exception("Gender column not found. Make sure the name searched for matches the name in the schema.");
            }
